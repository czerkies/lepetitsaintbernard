...
class modeleAvis extends modeleSuper {
  ...
  */
  public function existeAvis($id_commande_velo){
    ...
    $donnees = $this->bdd()->query("SELECT id_avis FROM avislpsb
  ...
  */
  public function insertAvis($id_commande_velo, $id_membre, $pseudo, $avis){
    ...
    $insertion = $this->bdd()->prepare("INSERT INTO avislpsb(id_commande_velo, id_membre, pseudo, avis, date) VALUES(:id_commande_velo, :id_membre, :pseudo, :avis, NOW())");
  ...
  */
  public function affichageAvisAdmin(){
    ...
    $donnees = $this->bdd()->query("SELECT a.*, DATE_FORMAT(a.date, '%d/%m/%Y') as date_fr, m.nom, m.prenom, c.id_commande
      FROM avislpsb a, membres m, commandes c
  ...
  */
  public function controleExistAvis($id_avis){
    ...
    $donnees = $this->bdd()->query("SELECT * FROM avislpsb WHERE id_avis = $id_avis");
  ...
  */
  public function suppAvis($id_avis){
    ...
    $delete = $this->bdd()->prepare("DELETE FROM avislpsb WHERE id_avis = $id_avis");
