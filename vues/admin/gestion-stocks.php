...
<?php if($donnesParPiece['cadres']){ ?>
  <div class="tableau">
    ...
    <ul class="body">
      <?php foreach($donnesParPiece['cadres'] as $value) { ?>
        <li>
...
<?php } ?>
<h2 id="roues">Gestion des Roues</h2>
<?php if($donnesParPiece['roues']){ ?>
  <div class="tableau">
    <div class="head">
      <div class="cel w5">Réf.</div>
      <div class="cel w20">Titre</div>
    ...
    <ul class="body">
      <?php foreach($donnesParPiece['roues'] as $value) { ?>
        <li>
          <span class="w5"><?= $value['id_piece']; ?></span>
          <span class="w20"><?= $value['titre']; ?></span>
          <span class="w20"><?= $value['type_velo']; ?></span>
